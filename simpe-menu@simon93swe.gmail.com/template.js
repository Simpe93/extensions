...
class ApplicationMenuItem extends PopupMenu.PopupBaseMenuItem {
    constructor(button, app) {
        ...
        let appLabel = new St.Label({ text: app.get_name(), y_expand: true, y_align: Clutter.ActorAlign.CENTER });
...
class DesktopTarget {
    constructor() {
        ...
        this._windowAddedId = global.window_group.connect('actor-added', this._onWindowAdded.bind(this));
...
class ApplicationsButton extends PanelMenu.Button {
    constructor() {
        ...
        this._label = new St.Label({ text: "MSS", y_expand: true, y_align: Clutter.ActorAlign.CENTER });
    ...
    _createLayout() {
        ...
        this.applicationsScrollBox = new St.ScrollView({ x_fill: true, y_fill: false, y_align: St.Align.START, style_class: 'simpe-menu vfade' });
        ...
        this.categoriesScrollBox = new St.ScrollView({ x_fill: true, y_fill: false, y_align: St.Align.START, style_class: 'vfade' });
        this.categoriesScrollBox.set_policy(Gtk.PolicyType.NEVER, Gtk.PolicyType.AUTOMATIC);
        vscroll = this.categoriesScrollBox.get_vscroll_bar();
        vscroll.connect('scroll-start', () => { this.menu.passEvents = true; });
        vscroll.connect('scroll-stop', () => { this.menu.passEvents = false; });
        this.leftBox.add(this.categoriesScrollBox, { expand: true, x_fill: true, y_fill: true, y_align: St.Align.START });

        let activities = new ActivitiesMenuItem(this);
        this.leftBox.add(activities.actor, { expand: false, x_fill: true, y_fill: false, y_align: St.Align.START });
...
function enable() {
    ...
    Main.panel.addToStatusArea('simpe-menu', appsMenuButton, 1, 'left');
}
